...
var requireConfig = {
	baseUrl: '../addons/lywywl_ztb/resource/webapp/plugin/js/app',
	paths: {
	...
	shim:{
		'ueditor': {
			deps: ['../addons/lywywl_ztb/resource/webapp/plugin/components/ueditor/third-party/zeroclipboard/ZeroClipboard.min.js', '../addons/lywywl_ztb/resource/webapp/plugin/components/ueditor/ueditor.config.js'],
			exports: 'UE',
