...
function pc_init(){
    ...
    picurl_ipt.val(module_url + "resource/template/tmp/tmp5/cover.jpg");
    picurl_ipt.parent().next().children().first().attr("src", module_url + "resource/template/tmp/tmp5/cover.jpg");
	//设置活动内容
    ...
    share_thumb_ipt.val(module_url + "resource/template/tmp/tmp5/cover.jpg");
    share_thumb_ipt.parent().next().children().first().attr("src", module_url + "resource/template/tmp/tmp5/cover.jpg");
	//设置活动分享描述
    ...
    qr_url_ipt.val(module_url + "resource/template/tmp/tmp5/qr.jpg");
    var img = $("#qr_bg");
    if(!img.attr('src')){
        $('#qrimg').click();
    }
    img.get(0).src = module_url + "resource/template/tmp/tmp5/qr.jpg";
}
...
function mobile_init(){
    ...
    $('input[name="model[title]"]').val('承包您的吃喝玩乐 千万福利 幸运锦鲤就是你');
	//设置活动封面图片
    $("#pic_url").attr("value", module_url + "resource/template/tmp/tmp5/cover.jpg");
    $(".js-image-pic_url").css({"position":"absolute" ,"opacity":"0"});
    $(".js-image-pic_url").next("div").html("<img src="+module_url+"resource/template/tmp/tmp5/cover.jpg />");
    //设置活动内容
    artEditor.clear();
    ...
    $('input[name="model[share_title]"]').val('承包您的吃喝玩乐千万福利幸运锦鲤就是你');
	//设置活动分享图标
    $("#share_thumb").attr("value", module_url + "resource/template/tmp/tmp5/cover.jpg");
    $(".js-image-share_thumb").css({"position":"absolute" ,"opacity":"0"});
    $(".js-image-share_thumb").next("div").html("<img src="+module_url+"resource/template/tmp/tmp5/cover.jpg />");
	//设置活动分享描述
    $('textarea[name="model[share_desc]"]').val('承包您的吃喝玩乐 千元福利 超值商品真的送给您 下一个幸运锦鲤就是你');
	//设置活动背景音乐
	...
	//设置分享海报
    $("#qr_url").attr("value", module_url + "resource/template/tmp/tmp5/qr.jpg");
    $(".js-image-qr_url").css({"position":"absolute" ,"opacity":"0"});
    $(".js-image-qr_url").next("div").html("<img src="+module_url+"resource/template/tmp/tmp5/qr.jpg />");
    $("#qr_bg,#qr_bg_edit").attr("src", module_url + "resource/template/tmp/tmp5/qr.jpg");
